...
impl CompactNFTRegistryEntries {
    ...
    pub fn kv_state(&self) -> KVPairVec {
        ...
        if self.has_extra_fields() {
            ...
            KVPairVec::new_unchecked(self.0.slice(start..))
        }
    }
...
impl molecule::prelude::Entity for CompactNFTRegistryEntries {
    ...
    fn as_builder(self) -> Self::Builder {
        Self::new_builder().kv_state(self.kv_state())
    }
}
#[derive(Clone, Copy)]
...
impl<'r> CompactNFTRegistryEntriesReader<'r> {
    ...
    pub fn kv_state(&self) -> KVPairVecReader<'r> {
        ...
        if self.has_extra_fields() {
            ...
            KVPairVecReader::new_unchecked(&self.as_slice()[start..])
        }
    }
}
...
impl molecule::prelude::Builder for CompactNFTRegistryEntriesBuilder {
    ...
    fn expected_length(&self) -> usize {
        molecule::NUMBER_SIZE * (Self::FIELD_COUNT + 1) + self.kv_state.as_slice().len()
    }
