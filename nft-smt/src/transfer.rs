...
pub struct OutPointBuilder(pub(crate) [Byte; 24]);
impl ::core::fmt::Debug for OutPointBuilder {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:?})", Self::NAME, &self.0[..])
    }
}
impl ::core::default::Default for OutPointBuilder {
    fn default() -> Self {
        OutPointBuilder([
            Byte::default(),
            Byte::default(),
...
impl ClaimedCompactNFTKey {
    ...
    pub const FIELD_SIZES: [usize; 2] = [1, 24];
    pub const TOTAL_SIZE: usize = 25;
    ...
    pub fn out_point(&self) -> OutPoint {
        OutPoint::new_unchecked(self.0.slice(1..25))
    }
...
impl<'r> ClaimedCompactNFTKeyReader<'r> {
    ...
    pub fn out_point(&self) -> OutPointReader<'r> {
        OutPointReader::new_unchecked(&self.as_slice()[1..25])
    }
}
...
impl WithdrawCompactNFTValue {
    ...
    pub const FIELD_SIZES: [usize; 5] = [8, 1, 1, 20, 24];
    ...
    pub fn out_point(&self) -> OutPoint {
        OutPoint::new_unchecked(self.0.slice(30..54))
    }
...
impl<'r> WithdrawCompactNFTValueReader<'r> {
    ...
    pub fn out_point(&self) -> OutPointReader<'r> {
        OutPointReader::new_unchecked(&self.as_slice()[30..54])
    }
}
